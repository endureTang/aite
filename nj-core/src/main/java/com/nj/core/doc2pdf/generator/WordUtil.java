...
public class WordUtil {
                    ...
                    if(text != null){
                        ...
                        for (Map.Entry<String, Object> entry : param.entrySet()) {
                            ...
                            if(text.indexOf(key) != -1){
                                ...
                                if (value instanceof Map==false) {//文本替换
	...
	public static void generateDocx(Map<String, Object> map, String templateFilePath, String outputFilePath) {
		
		CustomXWPFDocument doc = WordUtil.generateWord(map, templateFilePath);//将参数放入到模板中
		FileOutputStream fopts = null;
		try {
			fopts = new FileOutputStream(outputFilePath);
			doc.write(fopts);
