    ...
    <div class="modal-body">
        <div class="container-fluid">
            <div class="form-group">
                <input type="hidden" id="editId" name="id" value="${priceModel.id}" />
                <label for="stockNoEdit" class="col-sm-2 control-label">货品编号</label>
                <div class="col-sm-7">
                    <input id="stockNoEdit" name="stockNo" value="${priceModel.stockNo}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input id="specEdit" name="spec" value="${priceModel.spec}"
                           type="text" maxlength="32" minlength="2"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input id="priceEdit" name="price" value="${priceModel.price}"
                           type="text" maxlength="32" minlength="2"
