...
<section class="content-header">
	<ol class="breadcrumb">
		...
		<li><a href="right/subMenu?parentId=${pd.id}" data-target="navTab">子菜单信息</a></li>
	</ol>
</section>
			...
			<div class="box">
				<div class="box-header">
					<shiro:hasPermission name="right/addMenu">
						<button type="button" data-url="right/addMenu?parentId=${pd.id}" data-model="dialog"
		          ...
		          "render": function(data, type, row) {
		        	  var html = htmlTpl.dropdown.prefix
			            ...
			            <shiro:hasPermission name="right/deleteMenu">
			            	  + '  <li><a href="right/deleteMenu?id='+row.id+'" data-msg="将删除该菜单下的所有权限，确定删除吗？" data-model="ajaxToDo" data-callback="refreshTable"><i class="fa fa-trash-o"></i>删除</a></li>'
			            </shiro:hasPermission>
			            <shiro:hasPermission name="right/button">
			            	  + '  <li class="divider"></li>'
			            	  + '  <li><a href="right/button?id='+row.id+'" data-target="navTab">查看权限</a></li>'
			            </shiro:hasPermission>
