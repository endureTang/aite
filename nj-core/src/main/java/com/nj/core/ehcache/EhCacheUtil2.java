...
public class EhCacheUtil2 {  
    ...
    private static final String path = "/ehcache2.xml";  
    ...
    private static int timeToLiveSeconds = 60*10;//保存数据时间s
    ...
    private void addCacheIfNotExit(String cacheName){
    	if( ! manager.cacheExists(cacheName)){
    		Cache cache = new Cache(cacheName, 5000, false, false, timeToLiveSeconds, timeToLiveSeconds);
