...
/**
 * e签宝中创建企业账户时的传入参数的封装对象
 * @author wkh
 *
 */
public class ECCopoAcctInfo {

	private String name;		//机构名称,not null
	private String organCode;	//组织机构代码号、社会信用代码号或工商注册号，not null
	private int regType;		//企业注册类型，分三种，使用枚举类型OrganRegType，not null
	...
	public void setOrgType(int organType) {
