 ...
 * 资金渠道回款计划
 */
@ApiModel(description = "资金渠道回款计划")
public class CaptialMoneyBackNew extends MongoEntity {
    ...
    private String coporateId;                //资金渠道ID
    ...
    @Transient
    private List<CaptialMoneyBackDetaileNew> listMoneyBackDetaileNew;
    ...
    public List<CaptialMoneyBackDetaileNew> getListMoneyBackDetaileNew() {
        return listMoneyBackDetaileNew;
    }

    public void setListMoneyBackDetaileNew(List<CaptialMoneyBackDetaileNew> listMoneyBackDetaileNew) {
