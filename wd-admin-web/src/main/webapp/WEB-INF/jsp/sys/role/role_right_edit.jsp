...
<link href="${pageContext.request.contextPath}/static/plugins/zTree/css/zTreeStyle/zTreeStyle.css"
...
<form class="form-horizontal" action="role/editRight" method="post"
	...
	<div class="modal-footer">
		...
		<shiro:hasPermission name="role/editRight">
			<button type="button" class="btn btn-primary btn-save" onclick="submitForm()">保存</button>
		</shiro:hasPermission>
	</div>
</form>

<script src="${pageContext.request.contextPath}/static/plugins/zTree/js/jquery.ztree.all-3.5.min.js"
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$.post("role/resNodes","roleId=${roleId}", function(zNodes){
			console.log(zNodes);
	...
	function submitForm(){
		...
		if (selIds.length > 1) {
			...
			$.ajax({
				url: "role/editRight",
				type: "post",
				data: {roleId: "${roleId}", selIds: selIds},
				dataType: "json",
