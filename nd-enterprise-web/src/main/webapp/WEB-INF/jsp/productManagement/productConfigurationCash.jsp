                    ...
                    <div class="panel panel-info base-configuration">
                        ...
                        <div class="panel-body">
                            <ul>
                                ...
                                <li class="borrow" id="borrowMoneyType">
                                    <i class="con-name">定价策略 :</i>
                                    <div class="inblock">
                                        <label for="borrowMoneyType02"><input type="radio" name="borrowMoneyType" id="borrowMoneyType02" value="2">系统指定</label>
                                        <label for="borrowMoneyType03"><input checked type="radio" name="borrowMoneyType" id="borrowMoneyType03" value="3">风险定价</label>
                                    </div>
                                </li>

                                <li id="borrowInterval" class="hide-dom">
                                ...
                                <li id="borrowIntervalOther" class="hide-dom">
                                    <i class="con-name">借款金额 :</i>
                                    <input type="number" class="form-control" id="borrowIntervalOther01"
                                           placeholder="请不要超过50个字符">
                                </li>
                                <li class="borrow">
                                    ...
                                    <div>
                                        <div class="operate">
                                            ...
                                            <div id="type01feeType" class="clearfix feeType">
                                                <i class="con-name pull-left">趸收手续费(三选一):</i>
                                                <div>
                                                    <p>
                                            ...
                                            <div id="type01bondType" class="clearfix bondType">
                                                <i class="con-name pull-left">期收手续费(三选一):</i>
                                                <div>
                                                    <p>
                                                        <span class="title">固定金额</span>
                            ...
                            <!--<div class="uploading-info clearfix">-->
                                ...
                                <!--<div class="uploading-info-content">-->
                                    <!--<table class="table" id="upLoadTable">-->
                                        <!--&lt;!&ndash;<thead>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<tr>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<th colspan="4">资产佐证</th>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<th>类型</th>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<th>应用</th>&ndash;&gt;-->
                                        <!--&lt;!&ndash;</tr>&ndash;&gt;-->
                                        <!--&lt;!&ndash;</thead>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<tbody id="_assetProve">&ndash;&gt;-->
                                        <!--&lt;!&ndash;<tr>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<td>房产</td>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<td><input type="radio" name="_house">必填</td>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<td><input type="radio" name="_house">选填</td>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<td><input type="radio" name="_house">不填</td>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<td class="shallow">图片</td>&ndash;&gt;-->
                                        <!--&lt;!&ndash;<td class="shallow">应用获取用户手机拍照、灯光、储存卡使用权限</td>&ndash;&gt;-->
                                        <!--&lt;!&ndash;</tr>&ndash;&gt;-->
                        ...
                        <div class="panel-body">
                            <ul>
                                ...
                                <li class="hide" id="repaymentPlanWayOffsetDayBox">
                                    <i class="con-name">还款计划表生成时间:</i>
                                    用户指定日期<input style="margin: 0 10px;" value="0" class="form-control text-right" type="number"
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <select name="" id="engineMethod">
                                        ...
                                        <option value="generalCashLoanService">现金贷规则</option>
                                    </select>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            <select name="" id="firstNext" class="next-step-spe">
                                                <option value="">--下一步动作--</option>
                                                <option selected value="5">初审通过</option>
                                                <option value="51">复审通过</option>
                                                <option value="7">终审通过</option>
                                                <option value="8">等待用户确认</option>
                                            </select>
                                        </p>
                                        <p>
                                            ...
                                            <select name="" id="againNext" class="next-step-spe">
                                                <option value="">--下一步动作--</option>
                                                <option value="5">初审通过</option>
                                                <option selected value="51">复审通过</option>
                                                <option value="7">终审通过</option>
                                                <option value="8">等待用户确认</option>
                                            </select>
                                        </p>
                                ...
                                <li>
                                    ...
                                    <select name="" id="userConfirm" class="hide-dom">
                                        <option checked value="userConfirm">用户确认</option>
                                    </select>
                                </li>
                                <li>
                                <li>
                                    <i class="con-name">自动发标:</i>
                                    <input type="checkbox" name="sendMark" execOrders="8"
                                           value="10" data-name="自动发标" template-id=""><span>自动发标</span>
                                    <select name="" id="sendMarkNext" class="sepcial-left-user">
                                        <option value="">--下一步动作--</option>
                                        <option value="9">用户确认</option>
                                        <option value="10">生成标的物</option>
                                    ...
                                    <select name="" id="sendMark" class="hide-dom">
                                        <option checked value="sendMark">自动发标</option>
                                    </select>
                                </li>
                                <li>
                                    <i class="con-name">生成还款计划:</i>
                                    <input type="checkbox" name="replyPlan" execOrders="9" value="41"
                                           data-name="生成还款计划" template-id=""><span>生成还款计划</span>
                                    <select style="margin-left: 300px;" name="" id="replyPlanNext" class="next-step">
                                        <option value="">--下一步动作--</option>
                                        <option value="0">待开启审批流程</option>
                                        <option value="1">启动流程</option>
                                        <option value="2">决策引擎通过</option>
                                        ...
                                        <option value="8">生成合同</option>
                                        <option value="9">用户确认</option>
                                        <option selected value="61">还款计划创建成功</option>
                                        <option value="10">生成标的物</option>
                                        <option value="11">发标成功</option>
                                        <option value="12">募资成功/放款成功</option>
                                        <option value="15">发标失败/</option>
                                    ...
                                    <select name="" id="replyPlan" class="hide-dom">
                                        <option checked value="generateRepayPlanService">生成还款计划</option>
                                    </select>
                                </li>
                                <li>
                                    <i class="con-name">放款流程:</i>
                                    <input type="checkbox" name="autoLoan" execOrders="10" value="39"
                                    ...
                                    <select name="" id="autoLoan" class="hide-dom">
                                        <option checked value="cashLoanService">支付平台放款</option>
                                    </select>
                                </li>
                                <li>
                                    <i class="con-name">流程结束:</i>
                                    <input checked type="radio" name="finish" execOrders="11"
    ...
    var product = {
        ...
        processDom: {
            processCheckBox: {
                ...
                replyPlan: $('input[name="replyPlan"]'),
        ...
        bindBaseEvent: function () {
            ...
            $('#firToSec').on('click', function () {
                var params = {
                    ...
                    priceStrategy:self.getCheckboxItem('borrowMoneyType')[0], // 定价策略
                    productCycle: productCycle(),
                    borrowType: self.getCheckboxItem('borrowType')[0], // 借款类型
                ...
                if(params.priceStrategy==3){
                    ...
                    params.amountInfo = $.trim($('#borrowInterval01').val()) + '~' + $.trim($('#borrowInterval02').val());
                }
                if(params.priceStrategy==2){
                    params.amountInfo = $.trim($('#borrowIntervalOther01').val());
                }
                if (areaList().type != 0) {
                    if (areaList().ids == '') {
        ...
        renderBorrowUse: function (cb) {
            ...
            function borrowUseType(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    str += '<input type="radio" name="borrowUse" id="borrowUse0' + data[i].value + '" value="' + data[i].id + '">' + data[i].labelText;
                    str += '</label>';
                }
        ...
        renderBorrowType: function (cb) {
            ...
            function borrowType(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    str += '<input type="radio" name="borrowType" id="borrowType0' + data[i].value + '" value="' + data[i].id + '">' + data[i].labelText;
                    str += '</label>';
                }
        ...
        getBaseData: function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.status == 0) {
                        if(res.data.productInfo.priceStrategy){
                            moneyType(res.data.productInfo.priceStrategy);
                        }

                        renderProduct(res.data.productInfo);
                        self.borrowMoneyType().display();
                        if (res.data.typeList.length > 0) {
                            renderTypeUse(res.data.typeList[0], 'borrowType');
                        }
                        if (res.data.scopeList.length > 0) {
                            renderTypeUse(res.data.scopeList[0], 'borrowUse');
                        }
            ...
            // 策略定价
            function moneyType(priceStrategy) {
                var borrowMoneyType = $('input[name="borrowMoneyType"]');
                // borrowMoneyType.removeAttr('checked');
                if(priceStrategy==2){
                    $('#borrowMoneyType02').attr('checked',true);
                }else if(priceStrategy==3){
                    $('#borrowMoneyType03').attr('checked',true);
                }
                borrowMoneyType.iCheck({
                    radioClass: 'iradio_minimal-blue',
                });
                self.borrowMoneyType().display();
                self.borrowMoneyType().click();
            }
            // 渲染产品基本信息
            function renderProduct(data) {
                ...
                // 借款金额区间
                if(data.priceStrategy == 2){
                    $('#borrowIntervalOther01').val(data.amountInfo);
                }else if(data.priceStrategy == 3){
                    if (data.amountInfo) {
            ...
            function renderTypeUse(data, name) {
                ...
                a.each(function () {
                    if ($(this).val() == data.id) $(this).attr('checked', true);
                });
                a.iCheck({radioClass: 'iradio_minimal-blue'});
            }
        ...
        // 定价策略
        borrowMoneyType : function(){
            var self = this,
                borrowMoneyType = $('input[name="borrowMoneyType"]'),
                area = $('#borrowInterval'),
                input = $('#borrowIntervalOther');
          return {
              display : function () {
                  var domCheck = self.getCheckboxItem('borrowMoneyType')[0];
                  if(domCheck == 2){
                      area.addClass('hide-dom');
                      input.removeClass('hide-dom');
                  }else if(domCheck == 3){
                      area.removeClass('hide-dom');
                      input.addClass('hide-dom');
                  }
              },
              click : function () {
                  borrowMoneyType.on('ifClicked',function () {
                      if(this.value == 2){
                          area.addClass('hide-dom');
                          input.removeClass('hide-dom');
        ...
        bindProcessEvent: function () {
            ...
            $('#engine').siblings('ins').on('click', function () {
                if ($('#engine').is(':checked')) {
                    $('#engineMethod').val('generalCashLoanService');
                } else {
                    $('#engineMethod').val('');
                }
            })
            ...
            $('#creatProcess').click(function () {
                ...
                if (a.replyPlan.is(':checked')) {
                    c.push(a.replyPlan.attr('data-name'));
                }
            ...
            function saveChecked(cb) {
                ...
                // 自动发标
                getValueEx(a.sendMark, 'sendMarkNext', 'sendMark', '自动发标');
                // 还款计划
                getValueEx(a.replyPlan, 'replyPlanNext', 'replyPlan','生成还款计划');
                // 放款
                getValueEx(a.autoLoan, 'autoLoanNext','autoLoan', '放款');
                // 结束
                if (b.finish.is(':checked')) {
                    items.push({
                ...
                for (var i = 0; i < data.length; i++) {
                    switch (data[i].processId) {
                        ...
                        case 10 :
                            ...
                            break;
                        case 41 :
                            a.replyPlan.attr('checked', true);
                            $('#replyPlanNext').val(data[i].execAgreeStatus);
                            // $('#replyPlan').val(data[i].execFunction);
                            break;
                        case 39 :
                            a.autoLoan.attr('checked', true);
                            $('#autoLoanNext').val(data[i].execAgreeStatus);
                            $('#autoLoan').val(data[i].execFunction);
                            break;
                        case 99 :
