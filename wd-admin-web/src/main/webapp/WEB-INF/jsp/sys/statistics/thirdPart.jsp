...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li><a href="/statistics/thirdPart" data-target="navTab">三方接口调用</a></li>
    </ol>
</section>
<!-- Main content -->
            ...
            "columns": [
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a data-target="navTab" href="<%=basePath%>statistics/thirdPartByCompany?startTime='+$("#startTime").val()+'&endTime='+$("#endTime").val()+'&companyId=' + row.companyId + '">' + row.companyName + '</a>'
                    }
                },
                {"data": "succeedNum"},
                {"data": "failNum"},
