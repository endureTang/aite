...
dialogMng = {
    htmlContent:{
        ...
        closeButtonHtml:"",
        submitButtonHtml:"<div class='del-btn-submit'><button type='button' data-type='comfirm'>确认</button></div>",
        // warnTips : "<div class='error-page' style='min-height: 140px; overflow:hidden; margin-left: 20px; margin-top: -15px;'><h2 class='headline text-yellow'>#status</h2>"
        warnTips : "<div class='error-page' style='min-height: 140px; overflow:hidden; margin-top: -15px;'><h2 class='headline text-yellow'><img src='static/img/404.png'></h2>"
...
$(function(){
    ...
    $("body").delegate("*[data-model='navTab']","click",function(){
		var url = $(this).data("url");
		var md = $(this).attr("md");
		if(url){
			$("#navTab").load(url);
