	...
	<div class="modal-body">
		<div class="container-fluid">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input disabled id="discount" name="discount" type="text" maxlength="32" value="${pd.discount}"
						   minlength="1" class="form-control" placeholder="请输入折扣">
				</div>
			</div>
			<div class="form-group">
				<label for="basePrice" class="col-sm-2 control-label">吊牌价</label>
				<div class="col-sm-7">
					<input id="basePrice" name="basePrice" type="number" maxlength="32" value="${pd.basePrice}"
						   minlength="1" class="form-control" placeholder="请输入吊牌价">
				</div>
			</div>
			<div class="form-group">
