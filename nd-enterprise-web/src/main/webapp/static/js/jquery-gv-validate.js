...
jQuery.validator.addMethod("isInterestRate", function(value, element) {
    var length = value.length;
    // return this.optional(element) || /([5-6]\.\d)|([5-6]\d)/.test(value);
    return this.optional(element) || /^[5-6]+([.]{1}[5-6]+){0,1}$/.test(value);
}, "请正确填写批复利率");

jQuery.validator.addMethod("isIdCard", function(value, element) {
    var length = value.length;
    // return this.optional(element) || /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/.test(value);
    return this.optional(element) || /(^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3})|(^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X|x))$/.test(value);
}, "请正确填写身份证号码");
