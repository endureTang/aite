...
public class MoneyBackMainNew extends MongoEntity{
	...
	private List<MoneyBackNew> listMoneyBackNew;

	public List<MoneyBackNew> getListMoneyBackNew() {
		return listMoneyBackNew;
	}

	public void setListMoneyBackNew(List<MoneyBackNew> listMoneyBackNew) {
